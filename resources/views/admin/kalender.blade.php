...
@section('menu')
    ...
    <p class="btn btn-secondary text-light d-flex justify-content-between align-items-center me-3 "><a href="#" class="text-light m-1 ms-3 fw-bold"><i class=" me-2 bi bi-person-fill-up  ps-1 pe-1 rounded"></i> Kalender </a></p>
...
@section('menuHp')
                <div class="col text-center rounded-top bg-secondary">
                    <a href="" class="text-white"><p><i class="fa-regular fa-calendar-days m-0 p-0 pt-2"></i></p>
                    <p>Calendar</p></a>
                </div>
                ...
                <div class="col text-center">
                    <a href="" class="text-secondary"><p><i class="fa-solid fa-house-lock m-0 p-0 pt-2"></i></p>
                    <p>Booking</p></a>
                </div>
@endsection
