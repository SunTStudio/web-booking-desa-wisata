...
@section('menu')
<p class="d-flex justify-content-between align-items-center me-3 "><a href="{{ route('admin.dashboard') }}" class=" text-secondary m-1 ms-3 fw-bold"><i class="bi bi-key me-2  ps-1 pe-1 rounded"></i> Dashboard </a></p>
...
<p class="btn btn-secondary text-light d-flex justify-content-between align-items-center me-3 "><a href="{{ route('admin.laporan') }}" class="text-light fw-bold m-1 ms-3"><i class=" me-2 bi bi-key ps-1 pe-1 rounded"></i> Laporan </a> </p>
@endsection
